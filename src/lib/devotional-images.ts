...
export const devotionalImagePools = {
  shiva: [
    ...
    createImage('/images/shiva3.jpeg', 'Shiva meditation image'),
    createImage('/images/shiva4.jpeg', 'Shiva temple devotional image'),
    ...
    createImage('/images/shiva9.jpeg', 'Shiva ascetic portrait'),
    ...
    createImage('/images/shiva12.jpeg', 'Shiva Kailasa devotional image'),
    createImage('/images/shiva13.jpeg', 'Shiva sacred fire artwork'),
    createImage('/images/shiva14.jpeg', 'Shiva blue-throated devotional image'),
  ...
  devi: [
    ...
    createImage('/images/varalakshmi-vratam.png', 'Varalakshmi Vratam devotional artwork'),
  ],
  ganesha: [
  ...
  rama: [
    ...
    createImage('/images/Rama2.jpeg', 'Rama dharmic kingship image'),
