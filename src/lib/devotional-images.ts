...
export function getImageBySrc(images: readonly DevotionalImage[], src: string): DevotionalImage {
  const image = images.find((item) => item.src === src);

  if (!image) {
    throw new Error(`Image not found in pool: ${src}`);
  }
...
export const devotionalImagePools = {
  shiva: [
    ...
    createImage('/images/Shiva.jpeg', 'Shiva devotional image'),
    createImage('/images/shiva2.jpeg', 'Shiva sacred portrait'),
    createImage('/images/Shiva4.jpg', 'Shiva temple devotional image'),
    createImage('/images/Shiva5.jpg', 'Shiva devotional artwork'),
    createImage('/images/Shiva6.jpeg', 'Shiva Nataraja devotional image'),
    createImage('/images/Shiva7.jpeg', 'Shiva sacred contemplation'),
    createImage('/images/Shiva10.jpeg', 'Shiva luminous devotional artwork'),
    createImage('/images/Shiva11.jpeg', 'Shiva mountain stillness image'),
    createImage('/images/Shiva8.jpeg', 'Shiva Kailasa devotional image'),
    createImage('/images/Shiva9.jpeg', 'Shiva sacred fire artwork'),
    createImage('/images/Shiva3.jpeg', 'Shiva blue-throated devotional image'),
  ...
  vishnu: [
    ...
    createImage('/images/Venkateswara5.jpg', 'Venkateswara darshan image'),
    createImage('/images/Venkateswara4.jpg', 'Venkateswara shrine image'),
    createImage('/images/Vishnu.jpg', 'Vishnu devotional image'),
    createImage('/images/Vishnu3.JPG', 'Vishnu sacred artwork'),
  ...
  devi: [
    ...
    createImage('/images/Devi8.png', 'Devi sacred artwork'),
    ...
    createImage('/images/Devi6.jpeg', 'Devi luminous portrait'),
    createImage('/images/Devi7.jpeg', 'Devi sacred grace image'),
  ...
  hanuman: [
    ...
    createImage('/images/Hanuma5.jpg', 'Hanuman temple portrait'),
    createImage('/images/Hanuman2.jpeg', 'Hanuman bhakti artwork'),
    createImage('/images/Hanuman3.jpeg', 'Hanuman seva devotional image'),
    createImage('/images/Hanuman4.jpeg', 'Hanuman strength portrait'),
    createImage('/images/Hanuman6.jpeg', 'Hanuman Sundara Kanda image'),
    createImage('/images/Hanuman7.jpeg', 'Hanuman Ramabhakti artwork'),
    createImage('/images/Rama-Hanuma.jpeg', 'Rama and Hanuman seva image'),
  ],
  narasimha: [
    createImage('/images/Narsimha.jpg', 'Lakshmi Narasimha devotional image'),
    ...
    createImage('/images/Narasimha4.jpg', 'Narasimha devotional artwork'),
    createImage('/images/Narasimha5.jpg', 'Narasimha radiant image'),
  ],
  rama: [
    createImage('/images/Rama.jpg', 'Rama devotional image'),
    createImage('/images/Rama3.jpeg', 'Rama and Sita devotional image'),
    createImage('/images/Rama2.jpg', 'Rama sacred portrait'),
    createImage('/images/Rama5.jpg', 'Rama and bow devotional image'),
    createImage('/images/Rama4.jpeg', 'Rama Patha devotional artwork'),
    createImage('/images/Rama7.jpg', 'Rama bhakti artwork'),
    createImage('/images/Rama6.jpeg', 'Rama compassion devotional image'),
    createImage('/images/Rama-Hanuma.jpeg', 'Rama with Hanuman devotional image'),
    createImage('/images/Rama-Ravana.jpeg', 'Rama Ravana sacred narrative artwork'),
  ],
  krishna: [
    createImage('/images/Krishna.jpg', 'Krishna devotional image'),
    createImage('/images/Krishna10.jpeg', 'Krishna sacred portrait'),
  ...
  gita: [
    ...
    createImage('/images/Vishwaroopam.jpg', 'Vishwaroopam scene from the Bhagavad Gita'),
    createImage('/images/Bhagavadgita.jpeg', 'Bhagavad Gita sacred image'),
    createImage('/images/Bhagavadgita2.jpeg', 'Bhagavad Gita study image'),
  ...
  temples: [
    createImage('/images/Temple.jpg', 'Temple architecture devotional image'),
