...
import { devotionalImagePools, getImageBySrc, pickImage, rotateImages, type DevotionalImage } from '@/lib/devotional-images';
import { getStotraSummariesByDeity } from '@/lib/stotras';
...
function createFloatingOptions(
  images: readonly DevotionalImage[],
  excludedSrcs: readonly string[],
  offset = 0,
): DevotionalImage[] {
  const filtered = images.filter((image) => !excludedSrcs.includes(image.src));
  return filtered.length ? rotateImages(filtered, offset) : [];
}

function createRelatedResources(deitySlug: string): NonNullable<DeityProfile['relatedResources']> {
  return getStotraSummariesByDeity(deitySlug).map((entry) => ({
    title: entry.title,
    body: entry.body,
    href: entry.href,
...
export const deityProfiles = {
  shiva: {
    ...
    image: getImageBySrc(devotionalImagePools.shiva, '/images/Shiva.JPG'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.shiva, ['/images/Shiva.JPG'], 0), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.shiva, ['/images/Shiva.JPG'], 4), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.shiva, ['/images/Shiva.JPG'], 0),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.shiva, ['/images/Shiva.JPG'], 4),
    ...
    relatedResources: createRelatedResources('shiva'),
  ...
  vishnu: {
    ...
    image: getImageBySrc(devotionalImagePools.vishnu, '/images/Vishnu.jpg'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.vishnu, ['/images/Vishnu.jpg'], 1), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.vishnu, ['/images/Vishnu.jpg'], 5), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.vishnu, ['/images/Vishnu.jpg'], 1),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.vishnu, ['/images/Vishnu.jpg'], 5),
    ...
    relatedResources: createRelatedResources('vishnu'),
  ...
  devi: {
    ...
    image: getImageBySrc(devotionalImagePools.devi, '/images/Devi.jpg'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.devi, ['/images/Devi.jpg'], 1), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.devi, ['/images/Devi.jpg'], 4), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.devi, ['/images/Devi.jpg'], 1),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.devi, ['/images/Devi.jpg'], 4),
    ...
    relatedResources: createRelatedResources('devi'),
  ...
  ganesha: {
    ...
    image: getImageBySrc(devotionalImagePools.ganesha, '/images/Ganesha.jpg'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.ganesha, ['/images/Ganesha.jpg'], 0), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.ganesha, ['/images/Ganesha.jpg'], 1), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.ganesha, ['/images/Ganesha.jpg'], 0),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.ganesha, ['/images/Ganesha.jpg'], 1),
  ...
  hanuman: {
    ...
    image: getImageBySrc(devotionalImagePools.hanuman, '/images/Hanuma.jpg'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.hanuman, ['/images/Hanuma.jpg'], 1), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.hanuman, ['/images/Hanuma.jpg'], 4), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.hanuman, ['/images/Hanuma.jpg'], 1),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.hanuman, ['/images/Hanuma.jpg'], 4),
    ...
    relatedResources: createRelatedResources('hanuman'),
  ...
  krishna: {
    ...
    image: getImageBySrc(devotionalImagePools.krishna, '/images/Krishna6.jpg'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.krishna, ['/images/Krishna6.jpg'], 2), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.krishna, ['/images/Krishna6.jpg'], 6), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.krishna, ['/images/Krishna6.jpg'], 2),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.krishna, ['/images/Krishna6.jpg'], 6),
  ...
  rama: {
    ...
    image: getImageBySrc(devotionalImagePools.rama, '/images/Rama.jpg'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.rama, ['/images/Rama.jpg'], 2), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.rama, ['/images/Rama.jpg'], 5), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.rama, ['/images/Rama.jpg'], 2),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.rama, ['/images/Rama.jpg'], 5),
  ...
  narasimha: {
    ...
    image: getImageBySrc(devotionalImagePools.narasimha, '/images/Narsimha.jpg'),
    accentTopImage: pickImage(createFloatingOptions(devotionalImagePools.narasimha, ['/images/Narsimha.jpg'], 1), 0),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.narasimha, ['/images/Narsimha.jpg'], 3), 0),
    accentTopImageOptions: createFloatingOptions(devotionalImagePools.narasimha, ['/images/Narsimha.jpg'], 1),
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.narasimha, ['/images/Narsimha.jpg'], 3),
    ...
    relatedResources: createRelatedResources('narasimha'),
  ...
  ayyappa: {
    ...
    image: getImageBySrc(devotionalImagePools.ayyappa, '/images/Ayyappa.jpg'),
    accentTopImage: getImageBySrc(devotionalImagePools.ayyappa, '/images/Ayyappa2.jpg'),
    accentBottomImage: pickImage(createFloatingOptions(devotionalImagePools.temples, [], 2), 0),
    accentTopImageOptions: [...createFloatingOptions(devotionalImagePools.ayyappa, ['/images/Ayyappa.jpg'], 0), ...createFloatingOptions(devotionalImagePools.temples, [], 1)],
    accentBottomImageOptions: createFloatingOptions(devotionalImagePools.temples, [], 2),
