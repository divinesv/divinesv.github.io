      ...
      <section className="section-spacing">
        ...
        <div className="content-grid">
          {deityCards.map((deity) => (
            <Link key={deity.href} className="surface-card deity-path-card home-deity-path-card" href={deity.href}>
              <div className="deity-path-card-visual home-deity-path-card-visual">
      ...
      <section className="dual-grid section-spacing floating-section-shell home-library-feature-shell">
        ...
        <div className="devotional-panel">
          ...
          <div className="link-row">
            ...
            {featuredPdf ? (
              <Link className="secondary-link" href={featuredPdf.href}>
